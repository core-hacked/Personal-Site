...
if ($mobile_browser > 0) {
   ...
   $pixeltextstyle = "<br/><br/><div><h1 class=\"pixeltext-mobile\">404 - RESOURCE NOT FOUND</h1></div>";
   ...
   $showbr = "<br/>";
    ...
    $constructionstyle = "";
    $pixeltextstyle = "<h1 style=\"font-size:90px;\" class=\"pixeltext\">404 - RESOURCE NOT FOUND</h1>";
